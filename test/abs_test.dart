...
void main() {
  test('abs', () {
    ...
    isNegativeZero(Big('-0'));
    isNegativeZero(Big(minusZero));
    isPositiveZero(Big(-0).abs());
    isPositiveZero(Big('-0').abs());
    isPositiveZero(Big(minusZero).abs());

    t(double.minPositive, double.minPositive);
    t(double.minPositive, -double.minPositive);
    ...
    t('6.23417196172381875892300762819e-18',
    ...
    t('18', '1.8e+1');
    t('1.033525906631680944018544811261e-13',
